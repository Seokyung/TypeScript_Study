...
// 타입 지정
const parsedStudent2 = JSON.parse('{ "name": "송타스", "age": 17}'); // parsedStudent2는 { name: string; age: number } 타입으로 추론됨
const parsedStudent3 = JSON.parse('{ "name": "최개발", "age": 51}'); // parsedStudent3는 { name: string; age: number } 타입으로 추론됨
